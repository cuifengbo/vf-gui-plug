...
class ColorReplaceFilter extends vf.gui.Filter {
    _originalColor:any;
    _newColor:any;
    constructor() {
        ...
        this.originalColor = o.originalColor;
        this.newColor = o.newColor;
    ...
    set originalColor(value) {
        ...
        if (typeof value === 'number') {
            ...
            arr[1] = value[1];
            arr[2] = value[2];
            this._originalColor = vf.utils.rgb2hex(arr);
        }
    }
    get originalColor() {
    ...
    set newColor(value) {
        ...
        if (typeof value === 'number') {
            ...
            arr[1] = value[1];
            arr[2] = value[2];
            this._newColor = vf.utils.rgb2hex(arr);
        }
    }
    get newColor() {
