 ...
 * @private
 */
class TiltShiftAxisFilter extends vf.gui.Filter {

    constructor(blur = 100, gradientBlur = 600, start = null, end = null){
        super(vertex, fragment);
        this.uniforms.blur = blur;
        this.uniforms.gradientBlur = gradientBlur;
        this.uniforms.start = start || new vf.Point(0, window.innerHeight / 2);
        this.uniforms.end = end || new vf.Point(600, window.innerHeight / 2);
        this.uniforms.delta = new vf.Point(30, 30);
        this.uniforms.texSize = new vf.Point(window.innerWidth, window.innerHeight);
        this.updateDelta();
    }
