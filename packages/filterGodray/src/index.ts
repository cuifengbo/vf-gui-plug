...
class GodrayFilter extends vf.gui.Filter {
    _angleLight: any;
    parallel: boolean;
    center: any;
    time: any;
    ...
    constructor() {
        ...
        this._angleLight = new vf.Point();
        this.angle = o.angle;
        this.gain = o.gain;
        this.lacunarity = o.lacunarity;
    ...
    set angle(value) {
        ...
        const radians = value * vf.DEG_TO_RAD;
